...
Select Distinct e.elf_name AS "name", COALESCE(v.return_date, 'Still resting')
 AS "vacation end" FROM elves as e
LEFT OUTER JOIN vacations as v on e.elf_id = v.elf_id
Order by e.elf_name asc
